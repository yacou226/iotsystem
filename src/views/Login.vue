    ...
    <div class="max-w-lg mx-auto my-8 bg-white p-6 rounded-xl shadow shadow-slate-300">
        ...
        <form @submit="signIn" action="" class="my-10">
            <div class="flex flex-col space-y-5">
                ...
                <button @click="Google"  class="w-full py-3 font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg border-indigo-500 hover:shadow inline-flex space-x-2 items-center justify-center">
