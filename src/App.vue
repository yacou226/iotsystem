<template>
  <div class="h-screen w-screen rounded ">
    <div class=" border-1.5 rounded-t-lg  flex justify-between items-center mx-auto  bg-white py-4 px-6 rounded  ">
      <div class="h-12 w-12 cursor-pointed">
      ...
      <div class="flex items-center  ">
        <div class="flex ">
          <span>
            <button
              class="w-24 p-1  px-4 rounded text-white font-bold mr-4 bg-cyan-800 hover:transition duration-150 ease-in-out ">
              <router-link class="	" to="/login">Login</router-link>
            </button>
          </span>

          <span v-if="isLoggedIn">
            <button @click="logout()" class="bg-red-500 p-1  px-4 rounded text-white font-bold   hover:transition duration-150 ease-in-out ">Se
              déconnecter</button>
    ...
    <div class="  h-full w-full   mx-auto  bg-white rounded flex shadow-2xl ">
      <!-- side menu -->
      <div v-if="isLoggedIn" class="w-50   rounded-bl-lg ">
        <!-- Sidebar -->
        <div
          class=" flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar rounded-bl-lg">
            ...
            <ul class="flex flex-col py-4 space-y-1">
              ...
              <li>
                <a href="#"
                  ...
                  <span class="ml-2 text-sm tracking-wide truncate">Irrigation control</span>
                </a>
              </li>
              <li>
                <a href="#"
                  ...
                  <span class="ml-2 text-sm tracking-wide truncate">Gestion des stocks</span>
                </a>
              </li>
              <li>
                <a href="#"
      ...
      <!-- view port -->
      <div class="flex-auto bg-white rounded-b-lg h-full overflow-auto ">
