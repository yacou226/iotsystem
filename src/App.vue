...
<div class="h-screen w-screen rounded ">
   ...
   <span v-if="isLoggedIn">
        <button @click="logout()"  class="bg-red-500 p-1 px-4 rounded text-white font-bold mr-4 ">Se déconnecter</button>
...
<div class="  h-full w-full   mx-auto  bg-white rounded flex shadow-2xl ">
  ...
  <div v-if="isLoggedIn"  class="w-50   rounded-bl-lg ">
        <!-- Sidebar -->
      <div class=" flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar rounded-bl-lg">
